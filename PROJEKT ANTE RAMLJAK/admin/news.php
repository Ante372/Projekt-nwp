<?php 
	if (isset($_POST['_action_']) && $_POST['_action_'] == 'add_news') {
        ...
        if($_FILES['picture']['error'] == UPLOAD_ERR_OK && $_FILES['picture']['name'] != "") {
			...
			if ($ext == '.jpg' || $ext == '.png' || $ext == '.gif') {
				...
				$_SESSION['message'] .= '<p>Uspjesno ste dodali sliku.</p>';
			}
        }
		
		
		$_SESSION['message'] .= '<p>Uspjesno ste dodali vijesti!</p>';
	...
	if (isset($_POST['_action_']) && $_POST['_action_'] == 'edit_news') {
		...
		$_SESSION['message'] = '<p>Uspjesno ste izmijenili vijesti!</p>';
	...
	if (isset($_GET['delete']) && $_GET['delete'] != '') {
		...
		$_SESSION['message'] = '<p>Uspjesno ste obrisali vijest!</p>';
			...
			<table>
				...
				while($row = @mysqli_fetch_array($result)) {
					...
					<tr>
						...
						<td><a href="index.php?menu='.$menu.'&amp;action='.$action.'&amp;delete=' .$row['id']. '"><img src="img/delete.png" alt="obrisi"></a></td>
						<td>' . $row['title'] . '</td>
						<td>';
